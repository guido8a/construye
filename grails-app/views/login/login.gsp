...
<head>
    ...
    <g:if test="${janus.Parametros.findByEmpresaLike(message(code: 'ambiente2'))}">
        ...
        /*border: 5px solid #c2a970;*/
        border: 5px solid #20687a;
    </g:else>
...
<div class="centrado"><h1 class="titl" style="font-size: 32px;">${empr.empresa}</h1>
    ...
    <div class="dialog ui-corner-all logo">
        ...
        <div style="text-align: center ; color:#00485a; margin-top:90px; ">
...
<div class="modal login hide fade " id="modal-ingreso" style=";overflow: hidden;">
    <div class="modal-body" id="modalBody" style="padding: 0px">
        ...
        <g:form class="well form-horizontal span login2" action="validar" name="frmLogin">
            <p class="css-vertical-text" style="left: 12px;;font-family: 'Tulpen One',cursive;font-weight: bold;font-size: 35px; color: #334">Construye</p>
            ...
            <fieldset style="">
                ...
                <div class="control-group" style="margin-top: 0">
                    <label class="control-label" for="login" style="width: 100%;text-align: left;font-size: 25px;font-family: 'Tulpen One',cursive;font-weight: bolder; color: #00485a">Usuario:</label>
                ...
                <div class="control-group">
                    <label class="control-label" for="login" style="width: 100%;text-align: left;font-size: 25px;font-family: 'Tulpen One',cursive;font-weight: bolder; color:#00485a;">Password:</label>
